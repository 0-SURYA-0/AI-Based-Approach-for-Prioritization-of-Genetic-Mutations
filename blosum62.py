...
# Define the BLOSUM62 matrix as a dictionary
BLOSUM62_MATRIX = {
    ...
    ('Y', 'S'): -2, ('Y', 'T'): -2, ('Y', 'W'): 2, ('Y', 'Y'): 7, ('Y', 'V'): -2,
    
    ('V', 'A'): 0, ('V', 'R'): -3, ('V', 'N'): -3, ('V', 'D'): -3, ('V', 'C'): -1,
    ('V', 'Q'): -2, ('V', 'E'): -2, ('V', 'G'): -3, ('V', 'H'): -3, ('V', 'I'): 3,
    ('V', 'L'): 1, ('V', 'K'): -2, ('V', 'M'): 0, ('V', 'F'): -1, ('V', 'P'): -2,
    ('V', 'S'): -2, ('V', 'T'): 0, ('V', 'W'): -3, ('V', 'Y'): -2, ('V', 'V'): 4
}
